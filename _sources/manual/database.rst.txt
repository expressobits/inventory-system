...
.. note::   
    The demo already includes an example database, it is possible to use it, it is in the folder :guilabel:`&addons/inventory-system/demos/base/database.tres`

:ref:`create_database` shows how to create a new database.
