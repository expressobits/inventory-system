...
func _ready():
	...
	character_inventory_system.opened_inventory.connect(_on_player_inventory_opened.bind())
	character_inventory_system.closed_inventory.connect(_on_player_inventory_closed.bind())
