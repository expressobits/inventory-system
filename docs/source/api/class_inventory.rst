...
.. XML source: https://github.com/godotengine/godot/tree/master/docs/doc_classes/Inventory.xml.
...
- `Add items to inventory <https://github.com/expressobits/inventory-system/wiki/Inventory-Node#Add-items-to-inventory>`__
...
.. table::
   ...
   +----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``bool``       | :ref:`is_accept_any_categories<class_Inventory_method_is_accept_any_categories>`\ (\ categories_flag\: ``int``, slot\: :ref:`Array<class_Array>`\[:ref:`ItemCategory<class_ItemCategory>`\]\ ) |const| |
   +----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
Returns true if the slot index contains the amount of the specified :ref:`ItemStack<class_ItemStack>`\ (with String item_id from :ref:`InventoryDatabase<class_InventoryDatabase>`).
...
.. _class_Inventory_method_is_accept_any_categories:

.. rst-class:: classref-method

``bool`` **is_accept_any_categories**\ (\ categories_flag\: ``int``, slot\: :ref:`Array<class_Array>`\[:ref:`ItemCategory<class_ItemCategory>`\]\ ) |const| :ref:`🔗<class_Inventory_method_is_accept_any_categories>`
...
Removes an item_id amount to the specified inventory :ref:`Slot<class_Slot>` index and returns the remaining value that was not removed.
...
Remove slot with ``stack`` parameter, set ``emit_signal`` to false to disable events called by :ref:`update_stack()<class_Inventory_method_update_stack>`.
