...
.. table::
   ...
   +----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``bool``       | :ref:`is_accept_any_categories<class_Inventory_method_is_accept_any_categories>`\ (\ categories_flag\: ``int``, categories\: :ref:`Array<class_Array>`\[:ref:`ItemCategory<class_ItemCategory>`\]\ ) |const| |
   +----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
``bool`` **is_accept_any_categories**\ (\ categories_flag\: ``int``, categories\: :ref:`Array<class_Array>`\[:ref:`ItemCategory<class_ItemCategory>`\]\ ) |const| :ref:`🔗<class_Inventory_method_is_accept_any_categories>`
