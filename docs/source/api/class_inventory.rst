...
.. table::
   ...
   +----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``int``        | :ref:`add<class_Inventory_method_add>`\ (\ item_id\: ``String``, amount\: ``int`` = 1, properties\: ``Dictionary`` = {}, drop_excess\: ``bool`` = false, can_emit_item_added_signal\: ``bool`` = true\ )                                          |
   +----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``int``        | :ref:`add_at_index<class_Inventory_method_add_at_index>`\ (\ stack_index\: ``int``, item_id\: ``String``, amount\: ``int`` = 1, properties\: ``Dictionary`` = {}, can_emit_item_added_signal\: ``bool`` = true\ )                                 |
   +----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``int``        | :ref:`add_on_new_stack<class_Inventory_method_add_on_new_stack>`\ (\ item_id\: ``String``, amount\: ``int`` = 1, properties\: ``Dictionary`` = {}, can_emit_stack_added_signal\: ``bool`` = true, can_emit_item_added_signal\: ``bool`` = true\ ) |
   +----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``int``        | :ref:`add_to_stack<class_Inventory_method_add_to_stack>`\ (\ stack\: :ref:`ItemStack<class_ItemStack>`, item_id\: ``String``, amount\: ``int`` = 1, properties\: ``Dictionary`` = {}, can_emit_item_added_signal\: ``bool`` = true\ )             |
   +----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | ``float``      | :ref:`get_weight<class_Inventory_method_get_weight>`\ (\ ) |const|                                                                                                                                                                                |
   +----------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
``int`` **add**\ (\ item_id\: ``String``, amount\: ``int`` = 1, properties\: ``Dictionary`` = {}, drop_excess\: ``bool`` = false, can_emit_item_added_signal\: ``bool`` = true\ ) :ref:`🔗<class_Inventory_method_add>`
...
``int`` **add_at_index**\ (\ stack_index\: ``int``, item_id\: ``String``, amount\: ``int`` = 1, properties\: ``Dictionary`` = {}, can_emit_item_added_signal\: ``bool`` = true\ ) :ref:`🔗<class_Inventory_method_add_at_index>`
...
``int`` **add_on_new_stack**\ (\ item_id\: ``String``, amount\: ``int`` = 1, properties\: ``Dictionary`` = {}, can_emit_stack_added_signal\: ``bool`` = true, can_emit_item_added_signal\: ``bool`` = true\ ) :ref:`🔗<class_Inventory_method_add_on_new_stack>`
...
``int`` **add_to_stack**\ (\ stack\: :ref:`ItemStack<class_ItemStack>`, item_id\: ``String``, amount\: ``int`` = 1, properties\: ``Dictionary`` = {}, can_emit_item_added_signal\: ``bool`` = true\ ) :ref:`🔗<class_Inventory_method_add_to_stack>`
...
.. _class_Inventory_method_get_weight:

.. rst-class:: classref-method

``float`` **get_weight**\ (\ ) |const| :ref:`🔗<class_Inventory_method_get_weight>`
